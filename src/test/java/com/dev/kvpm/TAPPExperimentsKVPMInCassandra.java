...
public class TAPPExperimentsKVPMInCassandra {

	private CassandraAccessor accessor;
	private final Logger log = LoggerFactory
			.getLogger(TAPPExperimentsKVPMInCassandra.class);
	...
	@Test
	/*
	 * Run this against a CassandraServer started with -Dprovenance.collection=false
	 */
	public void testGetWithProvenanceTurnedOff() throws Exception {
		...
		for (int i = 0; i < dataSize; i++) {
			...
			String value = (String)accessor.direct_get(keyspace, columnFamily, rowKey, columnKey, timestamp);
	...
	@Test
	/*
	 * Run this against a CassandraServer started with -Dprovenance.collection=true
	 */
